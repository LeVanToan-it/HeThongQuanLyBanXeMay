...
public class FrmBaoHanh extends JFrame implements ActionListener, MouseListener{
	JLabel lblTitle, lblMaPhieu, lblTenLinhKien, lblLyDo, lblLoi, lblGia, lblMaNV, lblTenNV, lblMaKH, lblTenKH, lblTimKiem;
	...
	public FrmBaoHanh() {
		...
		lblMaPhieu.setBounds(50,50, w1, h);txtMaPhieu.setBounds(150,50, w2, h);
		lblTenLinhKien.setBounds(550, 50, w1, h);txtTenLinhKien.setBounds(650, 50, w2, h);
		
		lblLyDo.setBounds(50, 100, w1, h);txtLyDo.setBounds(150, 100, w2, h);
		//lblLoi.setBounds(550, 100, w1, h);cbxLoi.setBounds(650, 100, w2, h);
		
		lblGia.setBounds(50, 150, w1, h);txtGia.setBounds(150, 150, w2, h);
		
		lblMaNV.setBounds(50, 200, w1, h);txtMaNV.setBounds(150, 200, w2, h);
		lblTenNV.setBounds(550, 200, w1, h);txtTenNV.setBounds(650, 200, w2, h);
		
		lblMaKH.setBounds(50, 250, w1, h);txtMaKH.setBounds(150, 250, w2, h);
		lblTenKH.setBounds(550, 250, w1, h);txtTenKH.setBounds(650, 250, w2, h);
		...
		add(scroll=new JScrollPane(tableBH=new JTable(tableModelBH),JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED),BorderLayout.SOUTH);
...
////////////////////////////////////////////////////////////////////
	private void updateTableData() {
		...
		for(BaoHanh bh : list) {
			String[] rowData= {bh.getMaPhieu(),bh.getTenLinhKien(),bh.getLoi(),bh.getGia()+"",bh.getMaKH(),bh.getMaNV()};
...
/////////////////////////////////////////////////////////////////////////
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*else if(o.equals(btnSua)) {
			...
			if(row>=0) {
				DanhSachBaoHanh dsbh = new DanhSachBaoHanh();
				if(dsbh.update(txtMaPhieu.getText(), txtTenLinhKien.getText(),txtLyDo.getText(), Double.parseDouble(txtGia.getText().toString()),txtMaKH.getText(), txtMaNV.getText())) {
					tableBH.setValueAt(txtTenLinhKien.getText(), row, 1);
...
///////////////////////////////////////////////////////////////////////////////
	public boolean validData () {
		String maPhieu = txtMaKH.getText().trim();
		String tenLinhKien = txtTenKH.getText().trim();
		String lyDo = txtLyDo.getText().trim();
		String loi = cbxLoi.getSelectedItem().toString().trim();
		...
		if (cbxLoi.getSelectedItem() == "Khách hàng") {
			if (!(gia.length() > 0)) {
