...
public class FrmHopDongTraHet extends JFrame implements ActionListener,MouseListener{
	...
	public FrmHopDongTraHet() throws HeadlessException{
		...
		lblSoTienTra.setBounds(50, 190, w1, h);txtSoTienTra.setBounds(150, 190, w2, h);
		lblNgayLap.setBounds(550, 190, w1, h);txtNgayLap.setBounds(650, 190, w2, h);
		...
		frmmuahang.getButton2().addActionListener(new ActionListener() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*if(e.equals(btnThem)){
			...
			if(dshdtg.create(txtMaHD.getText(), txtTenKH.getText(), txtTenXe.getText(), Integer.parseInt(txtSoLuong.getText()), Double.parseDouble(txtDonGia.getText()),Integer.parseInt(txtlanTra.getText()), Double.parseDouble(txtSoTienTra.getText()),txtNgayTra.getText())) {
		...
		/*if(o.equals(btnSua)) {
			int row =table.getSelectedRow();
			if(row>=0) {
				if(dshdth.update(txtMaHD.getText(), txtTenKH.getText(),txtTenXe.getText(),Integer.parseInt(txtSoLuong.getText()), Double.parseDouble(txtDonGia.getText()), Double.parseDouble(txtThanhTien.getText()),Double.parseDouble(txtSoTienTra.getText()), txtNgayLap.getText())) {
					table.setValueAt(txtMaHD.getText(), row, 1);
	...
	private void updateTableData() {
		...
		for(HopDongTraHet hd: list) {
			String[] rowData= {hd.getMaHD(),hd.getTenKH(),hd.getTenxe(),hd.getSoLuong()+"",en.format(hd.getDonGia())+"",en.format(hd.getThanhTien())+"",en.format(hd.getSoTienTraHet())+"",hd.getNgayLap()};
			dataModel.addRow(rowData);
		}
