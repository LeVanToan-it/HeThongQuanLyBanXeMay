...
public class FrmKhachHang extends JFrame implements ActionListener,MouseListener {
	...
	public FrmKhachHang() throws HeadlessException{
		...
		lblMaKH.setBounds(50,100, w1, h);txtMaKH.setBounds(150,100, w2, h);
		lblTenKH.setBounds(550, 100, w1, h);txtTenKH.setBounds(650, 100, w2, h);
		
		lblDiaChi.setBounds(50, 150, w1, h);txtDiaChi.setBounds(150, 150, w2, h);
		lblDienThoai.setBounds(550, 150, w1, h);txtDienThoai.setBounds(650, 150, w2, h);
		...
		add(scroll=new JScrollPane(tableKH=new JTable(tableModelKH),JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED),BorderLayout.SOUTH);
