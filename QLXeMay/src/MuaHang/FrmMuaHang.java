...
public class FrmMuaHang extends JFrame implements ActionListener,MouseListener{
	...
	public FrmMuaHang() throws HeadlessException{
		...
		JScrollPane scroll1;
		String[] header={"Mã xe","Tên xe","Màu xe","Loại xe","Nhà cung cấp","Đơn giá"};
		...
		JScrollPane scroll2;
		String[] headers= {"Mã xe","Tên xe","Số lượng","Đơn giá","Thành tiền","Ngày Lập"};
	...
	private void updateTableData() {
		...
		for(Xe x : list) {
			String[] rowData= {x.getMaXe(),x.getTenXe(),x.mauXe,x.loaiXe,x.nhaCungCap,x.getGiaXe()+""};
